function getData() {
  fetch("sensor.json").then(response => {
...
function updateHtml(data) {
  ...
  document.getElementById("T").innerHTML = "T: " + data.t + " °C";
  document.getElementById("P").innerHTML = "P: " + data.p + " hPa";
  ...
  document.getElementById("containerS1").style.background = "Lime";
  document.getElementById("containerS1").style.color = "black"
  document.getElementById("containerS2").style.background = "Lime";
}
